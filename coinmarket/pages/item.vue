        ...
        <div class="item__container">
          ...
          <div class="item__left">
            <div class="item__lefttop item__projectdetail" v-if="$route.query.category === 'icoitem'">
              ...
              <div class="item__projectdetail--p" v-html="$route.query.about"></div>
              <div class="item__projectdetail--p" v-html="$route.query.additional_info"></div>
            </div>

            <div class="item__lefttop" v-if="$route.query.category !== 'icoitem'">
              <TradingWidget />
            </div>
    ...
    methods: {
      ...
      boardDummyDataGen(optional) {
        ...
        const boardDummyData = {
          txns: this.formatNumber(generateRandomNumber(30, 100)),
          volume: this.formatNumber(generateRandomNumber(1000, 6000)),
          makers: this.formatNumber(generateRandomNumber(40, 65)),
          buys: this.formatNumber(generateRandomNumber(10, 500)),
          sells: this.formatNumber(generateRandomNumber(10, 500)),
          buy_vol: this.formatNumber(generateRandomNumber(1000, 6000)),
          sell_vol: this.formatNumber(generateRandomNumber(1000, 6000)),
          buyers: this.formatNumber(generateRandomNumber(20, 100)), 
